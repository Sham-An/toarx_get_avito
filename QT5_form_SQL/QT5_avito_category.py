...
# Конец 1-й вставки
stm.setTable('category') #category
...
stm.setRelation(2, QtSql.QSqlRelation('parent_cat', 'id', 'name'))
# quer = ('SELECT * FROM category ORDER BY id LIMIT 3')
stm.select()  # quer)
stm.setHeaderData(0, QtCore.Qt.Horizontal, 'Cat_id')
stm.setHeaderData(1, QtCore.Qt.Horizontal, 'Cat_name')
#stm.setHeaderData(2, QtCore.Qt.Horizontal, 'City_id')
stm.setHeaderData(2, QtCore.Qt.Horizontal, 'Group')
