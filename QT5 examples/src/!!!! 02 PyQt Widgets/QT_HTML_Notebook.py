...
import os
import sys
#pip install C:\Python3\PyQt6-6.4.0-cp37-abi3-win_amd64.whl
#pip install --upgrade --no-deps --force-reinstall C:\Python3\PyQt6-6.4.0-cp37-abi3-win_amd64.whl
...
class MainWindow(QMainWindow):
    ...
    # when double clicked is pressed on tabs
        ...
        #i = self.tabs.addTab(tab1, label)
        self.tabs.addTab(tab1, "&Table")
        self.tabs.addTab(tab2, "Text &Edit")
        #self.tabs.setCurrentIndex(i)
