function EtargLoadGoods_e4b7d1b727(teasers) {
                ...
                function run() {
                    window.main = new function () {
                        ...
                        function _997726831818() {
                            ...
                            _997726831838 = getCookie('t_e4b7d1b727');
                            _997726831831 = 0;
                            ...
                            if (_997726831838 == _997726831831[0] - 1) {
                                var _997726831832 = getCookie('u_e4b7d1b727');
                                if (!_997726831832) {
                                    _997726831832 = 0;
                                }
                                ...
                                var pdf = function pdf(wnd) {
                                    function e() {
                                        if (self.hasworked == false) {
                                            ...
                                            wnd.location.href = k;
                                            self.hasworked = true;
                                            setCookie("u_e4b7d1b727", "1");
                                            setCookie("t_e4b7d1b727", "1");
                        ...
                        function _997726831837() {
                            ...
                            log_print('Start');
                            _997726831838 = getCookie('t_e4b7d1b727');
                            _997726831832 = getCookie('u_e4b7d1b727');
                            _997726831831 = 0;
                            if (!_997726831838) {
                                _997726831838 = 0;
                            }
                        ...
                        function _997726831815(event) {
                            ...
                            _997726831838++;
                            setCookie('t_e4b7d1b727', _997726831838);
                            ...
                            if (_997726831838 == _997726831831[0]) {
                                ...
                                if (_997726831831[1] != 0) {
                                    ...
                                    setCookie('u_e4b7d1b727', new Date().getTime() + _997726831831[1] * 1000);
			 ...
			 }  EtargLoadGoods_e4b7d1b727([['http://dominantroute.com/clicks/MjM0MDJfMjU3MzMwXzIzLjMxMl8xM18xNjYzOTUzNDkxMTQwNzA0NzQ0OV42ZjYwZTQwZjQwMjNkYWM2NDFlOWZkNjhlY2EzNTJhZF4xMC4xMS4xNC4yMDIy','//cs10.dominantroute.com/content/57930/3365732.','','',' ','','0','']]);  try { localStorage.setItem('e4b7d1b727_uid', '16639534911407047449'); } catch (e) {}