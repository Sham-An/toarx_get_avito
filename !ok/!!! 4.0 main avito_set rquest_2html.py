...
# ?cd=1
# &f=ASgCAgECAUXGmgwXeyJmcm9tIjoyMDAwLCJ0byI6NzAwMH0
# &q=скутер
# &s=1
#
...
CIPHERS = """ECDHE-RSA-AES256-GCM-SHA384:ECDHE-RSA-AES256-SHA:ECDHE-RSA-AES256-SHA384"""
...
def main():
    ...
    try:
        ...
        #res = r.json()
        #print(res.content)
        with open('results_xml_3.html', 'w', encoding='utf-8') as file:
            file.write(r.text)
