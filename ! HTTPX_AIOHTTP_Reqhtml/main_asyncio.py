...
async def gather_data():
    ...
    url1 = "https://www.labirint.ru/genres/2308/?available=1&paperbooks=1&display=table"
    url = "https://www.avito.ru/tarasovskiy/mototsikly_i_mototehnika?cd=1&radius=50&searchRadius=50"
    url2 = "https://streamable.com"
    async with aiohttp.ClientSession() as cs: #session:
        async with cs.ClientSession(headers={"Referer": url2}) as r:
            print(r.text)
